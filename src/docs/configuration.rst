...
``aux-libraries`` allows to add one or more js libraries via cdn links for usage in `render-html <#render-html>`_. The keyword expects a list of urls that link to the js libraries.
